...
public class AlunoAdapter extends RecyclerView.Adapter<AlunoAdapter.AlunoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AlunoViewHolder holder, int position) {
        ...
        holder.edDtNascimento.setText(aluno.getDtNascimento());
    }
    ...
    public class AlunoViewHolder extends RecyclerView.ViewHolder {
        ...
        public AlunoViewHolder(@NonNull View itemView) {
            ...
            edRaAluno      = (TextInputEditText)itemView.findViewById(R.id.edRaAlunoView);
            edNomeAluno    = (TextInputEditText)itemView.findViewById(R.id.edNomeAlunoView);
            edCpfAluno     = (TextInputEditText)itemView.findViewById(R.id.edCPFAlunoView);
            edCurso        = (TextInputEditText)itemView.findViewById(R.id.edCursoAlunoView);
            edPeriodo      = (TextInputEditText)itemView.findViewById(R.id.edPeriodoAlunoView);
            edDtMatricula  = (TextInputEditText)itemView.findViewById(R.id.edDtInscricaoAlunoView);
            edDtNascimento = (TextInputEditText)itemView.findViewById(R.id.edDtNascimentoAlunoView);
        }
    }
}
